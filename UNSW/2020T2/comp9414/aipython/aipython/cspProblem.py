...
class Constraint(object):
    ...
    * condition: a function that can applied to a tuple of values
    ...
    def holds(self,assignment):
        ...
        """
        print("holds:")
        print(self.condition(*tuple(assignment[v] for v in self.scope)))
...
class CSP(object):
    ...
    * var_to_const, a variable to set of constraints dictionary
    ...
    def __repr__(self):
        ...
        #print("repr:  ", "CSP("+str(self.domains)+", "+str([str(c) for c in self.constraints])+")")
